...
class Cart extends Component {
    constructor(props) {
        ...
        if (localStorage.getItem("cart_res_id")) {
            this.props.getRestaurant(localStorage.getItem("cart_res_id"));
        }
    }
    ...
    render() {
        ...
        if (this.state && this.state.restaurant) {
            ...
            resAddress = this.state.restaurant.res_address;
...
const mapStateToProps = state => ({
    restaurant: state.restaurant.restaurant_data
});

export default connect(mapStateToProps, { getRestaurant })(Cart);
