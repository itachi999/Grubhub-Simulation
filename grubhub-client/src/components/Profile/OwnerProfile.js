...
import { getOwner, updateOwner } from '../../actions/profileActions';
import { uploadUserImage, uploadRestaurantImage } from '../../actions/imageUploadActions';
...
class OwnerProfile extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.user_image) {
            var { user_image } = nextProps;
        ...
        if (nextProps.res_image) {
            var { res_image } = nextProps;

            if (typeof res_image === "string") {
                this.setState({
    ...
    onResUpload = (e) => {
        ...
        axios.post(`${backendServer}/grubhub/uploads/restaurant/${this.state.user_id}`, formData, uploadConfig)
            .then(response => {
    ...
    onUserUpload = (e) => {
        ...
        this.props.uploadUserImage(formData, uploadConfig);
    }
...
OwnerProfile.propTypes = {
    ...
    user_image: PropTypes.object.isRequired,
    res_image: PropTypes.object.isRequired
}


const mapStateToProps = state => ({
    user: state.profile.user,
    user_image: state.image.user_image,
    res_image: state.image.res_image,    
});

export default connect(mapStateToProps, { getOwner, updateOwner, uploadUserImage, uploadRestaurantImage })(OwnerProfile);
