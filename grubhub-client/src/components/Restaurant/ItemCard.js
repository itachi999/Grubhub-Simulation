      ...
      <div>
        <Card bg="white" style={{ width: "50rem", margin: "2%" }}>
          <Row>
            ...
            <Col align="right">
              <br /><br />
              <Button variant={buttonVariant} onClick={buttonClick} name={this.props.menu_item._id}>{buttonText}</Button>&nbsp; &nbsp;
            </Col>
          </Row>
        </Card>
        <Modal show={showModal} onHide={this.onClose} centered>
          ...
          <Modal.Body>
            <center>
              ...
              Quantity: <input type="number" name={this.props.menu_item._id} min="1" max="10" width="10%" onChange={this.onQuantityChange} defaultValue="1" autofocus></input>
            </center>
          </Modal.Body>
          <Modal.Footer>
